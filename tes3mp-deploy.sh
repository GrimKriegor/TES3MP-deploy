...
if [ $INSTALL ]; then
  ...
  case $DISTRO in
    ...
    "fedora" )
        ...
        sudo dnf --refresh install unzip wget cmake openal-devel OpenSceneGraph-qt-devel SDL2-devel qt4-devel boost-filesystem git boost-thread boost-program-options boost-system ffmpeg-devel ffmpeg-libs bullet-devel gcc-c++ mygui-devel unshield-devel tinyxml-devel cmake luajit #llvm35 llvm clang ncurses
        BUILD_BULLET=true
    ;;
